...
var getdepto = require('./routes/getdepto');
var getcie10 = require('./routes/getcie10');
...
app.use('/', index);
app.use('/getcs', getcs);
app.use('/getdepto', getdepto);
app.use('/getcie10', getcie10);
